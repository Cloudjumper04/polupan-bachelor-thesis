...
def get_load_history_range(
    session: Session,
    station_id: str,
    config_hash: str,
) -> tuple[datetime | None, datetime | None]:
    return _point_range(session, LoadHistoryPoint, station_id, config_hash)


def get_load_cache_range(
    session: Session,
    station_id: str,
    config_hash: str,
) -> tuple[datetime | None, datetime | None]:
    return _point_range(session, LoadCachePoint, station_id, config_hash)


def get_load_point_range(
    session: Session,
    station_id: str,
    config_hash: str,
) -> tuple[datetime | None, datetime | None]:
    return _combine_ranges(
        get_load_history_range(session, station_id, config_hash),
        get_load_cache_range(session, station_id, config_hash),
    )
